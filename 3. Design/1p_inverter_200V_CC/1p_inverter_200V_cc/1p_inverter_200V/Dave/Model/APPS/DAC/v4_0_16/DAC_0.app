...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DAC" URI="http://resources/4.0.16/app/DAC/0" description="Generates Pattern, Noise and Ramp waveform.&#xA; It can be used for single value and data processing modes." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="DAC_0" appLabel="">
  ...
  <hwResources name="Pin" URI="http://resources/4.0.16/app/DAC/0/__pin_hwres_dac_analogpin" resourceGroupUri="devicepackage/0/*" mResGrpUri="devicepackage/0/*">
